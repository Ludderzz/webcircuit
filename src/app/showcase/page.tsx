...
export default async function ShowcasePage() {
  // Fetch only 'complete' jobs that have a screenshot
      ...
      <main className="max-w-[1600px] mx-auto">
        ...
        <header className="max-w-3xl mb-16 px-2">
          ...
          <p className="text-base md:text-lg text-slate-400 leading-relaxed max-w-xl">
            A curated selection of platforms, interfaces, and ecosystems we've engineered from the ground up. These are live updates straight from our admin panel
          </p>
        </header>

        {/* The Grid: 2 columns on mobile, 3 columns on Desktop (lg screens) */}
