...
import { ArrowRight, Zap, Shield, BarChart3, ChevronRight, Code2, Rocket, MessageSquare, Layers, X, Check, Timer, TrendingUp, DollarSign } from 'lucide-react'
      ...
      <section className="relative pt-40 pb-20 px-6">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-10 leading-relaxed">
            High-performance digital products for founders who care about speed, 
            scalability, and world-class aesthetics.
          </p>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-slate-400 mb-8 text-lg">Most agencies deliver "working" code. We deliver competitive advantages. Slow sites lose 7% of conversions per second—we make sure you keep them.</p>
            
            <div className="space-y-4">
              {[
                { text: "Proprietary Edge-Rendering Architecture", icon: Check },
                { text: "Direct WhatsApp access to lead engineers", icon: Check },
            ...
            <div className="grid grid-cols-2">
              <div className="p-8 border-r border-slate-800">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-2 text-slate-500 text-sm line-through"><X className="w-4 h-4 mt-1 flex-shrink-0" /> Junior Devs Only</li>
              ...
              <div className="p-8 bg-blue-600/5">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-2 text-blue-100 text-sm font-bold"><Check className="w-4 h-4 mt-1 flex-shrink-0 text-blue-400" /> Lead Engineer Assigned</li>
      ...
      <section className="py-32 px-6 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">OUR PROCESS</h2>
            <p className="text-slate-500 italic">From concept to deployment in 4 stages</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: MessageSquare, title: 'Discovery', desc: 'Deep dive into your business goals and user needs.' },
              { icon: Layers, title: 'Architecture', desc: 'Mapping out the tech stack and database schema.' },
              { icon: Code2, title: 'Production', desc: 'Rapid development with weekly staging updates.' },
              { icon: Rocket, title: 'Launch', desc: 'Global deployment and performance monitoring.' },
            ].map((step, i) => (
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto p-12 md:p-20 rounded-[40px] bg-gradient-to-br from-blue-600 to-indigo-700 text-center relative overflow-hidden shadow-2xl">
          ...
          <p className="text-blue-100 mb-12 text-lg md:text-xl max-w-xl mx-auto relative z-10">
            We're currently taking on new projects. Let's talk about your vision and how we can make it a reality.
          </p>
